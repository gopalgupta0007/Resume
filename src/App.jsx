...
//             {[
//               { deg: 'M.Sc. (Information Technology)', inst: 'CGPA : 9', yr: '2024 – 2026', extra: 'Completed Apr 2026' },
//               { deg: 'B.Sc. (Information Technology)', inst: 'CGPA : 9', yr: '2021 – 2024', extra: 'Apr 2024' },
...
/* ════════════════════════════════════════════════════════════
   RESUME 3 — ATS-Optimised (target 100/100)
   Rules enforced:
   • Single column, zero CSS grid/flex columns for content
   • No decorative elements (no arcs, no gradients, no sidebar)
   • Standard HTML list bullets for all bullet points
   • Plain Arial/sans-serif — 100% ATS-parseable
   • All standard sections in ATS-expected order
   • LinkedIn URL added
   • Quantified impact in every Carufus bullet
   • TypeScript, GitHub Actions, LinkedIn keywords added
...
const Resume3 = () => {
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      const c2 = await captureEl(page2Ref.current);
      pdf.addImage(c2.toDataURL('image/png', 1), 'PNG', 0, 0, pw, Math.min((c2.height * pw) / c2.width, ph));
      pdf.save('gopal_gupta_resume_ats.pdf');
    } catch (e) {
      console.error(e);
      alert('Error generating PDF. Please try again.');
    }
  ...
  return (
    <div className="ats-outer">
      ...
      <div className="ats-page" ref={page1Ref}>
        ...
        <div className="ats-title-line">MERN Stack Developer | Full Stack Software Developer | React.js | Node.js | SQL Server</div>

        <div className="ats-contact-row">
          Mumbai, Maharashtra, India &nbsp;|&nbsp; +91 9082257079 &nbsp;|&nbsp; guptagopal18082003@gmail.com
        </div>
        <div className="ats-contact-row">
          LinkedIn: <a href="https://linkedin.com/in/gopalgupta0007" target="_blank" rel="noreferrer">linkedin.com/in/gopalgupta0007</a>
          &nbsp;|&nbsp;
          GitHub: <a href="https://github.com/gopalgupta0007" target="_blank" rel="noreferrer">github.com/gopalgupta0007</a>
          &nbsp;|&nbsp;
          RandomType: <a href="https://randomtypee.netlify.app/" target="_blank" rel="noreferrer">randomtypee.netlify.app</a>
        </div>
        ...
        <div className="ats-sec">
          <div className="ats-sec-title">Professional Summary</div>
          <p className="ats-summary">
            Results-driven <strong>Full Stack MERN Developer</strong> and <strong>Software Developer</strong> with 2+ years of professional
            experience building and deploying enterprise-grade ERP, HRMS, and Employee Management portals.
            Proficient in <strong>React.js, Node.js, Express.js, MongoDB, SQL Server (SSMS), and .NET APIs</strong>.
            Hands-on experience with <strong>CI/CD automation, Agile/Scrum methodology, RESTful API design,
            version control (Git/GitHub), UAT and PROD environment management</strong>, and
            <strong> Agentic AI integration</strong>.
            Recognized as <strong>Employee of the Month (May 2026)</strong> at Carufus Technology.
            Completed M.Sc. (I.T.) from Mumbai University with CGPA 9.0.
            Seeking a full stack or software developer role to deliver scalable, high-performance web applications.
          </p>
        </div>

        <hr className="ats-divider-light" />

        {/* TECHNICAL SKILLS */}
        <div className="ats-sec">
          <div className="ats-sec-title">Technical Skills</div>
          <div className="ats-skills-block">
            <div><strong>Frontend:</strong> React.js, Angular.js, HTML5, CSS3, JavaScript (ES6+), TypeScript (basics), Bootstrap, Responsive Web Design</div>
            <div><strong>Backend:</strong> Node.js, Express.js, .NET APIs, RESTful API Design, RESTful Services</div>
            <div><strong>Database:</strong> MongoDB, MySQL, SQL Server (SSMS), SQL Scripting, Stored Procedures, Query Optimization</div>
            <div><strong>DevOps &amp; Tools:</strong> Git, GitHub, GitHub Actions (CI/CD), VS Code, Postman, Ubuntu Server, Remote Desktop Connection, Batch File Automation</div>
            <div><strong>Deployment:</strong> Netlify, Vercel, Ubuntu Server, UAT &amp; PROD Environment Management</div>
            <div><strong>AI &amp; Automation:</strong> Agentic AI, Natural Language Processing (NLP), Natural Language to SQL, Pabbly Connect, Zoho Mail API</div>
            <div><strong>Methodologies:</strong> Agile, Scrum, Sprint Planning, Daily Standups, Test Case Creation, QA &amp; Testing, Bug Resolution</div>
            <div><strong>Other:</strong> Core Java, OOP, Firebase (Auth, OTP), Google Cloud Platform (GCP), Third-party API Integration, Certificate Generation Automation</div>
          </div>
        </div>
        ...
        {/* PROFESSIONAL EXPERIENCE */}
        <div className="ats-sec">
          <div className="ats-sec-title">Professional Experience</div>

          {/* Carufus */}
          <div className="ats-exp">
            <div className="ats-exp-header">
              <div className="ats-exp-left">
                <div className="ats-exp-co">Carufus Technology — Mumbai, India</div>
                <div className="ats-exp-role">Software Developer | Full Stack Developer (MERN + .NET)</div>
              </div>
              <div className="ats-exp-date">May 2024 – Present</div>
            </div>
            <div className="ats-award-line">★ Employee of the Month — May 2026</div>
            <ul className="ats-ul">
              <li>Led <strong>feature enhancement and new feature development</strong> for <strong>Wow! Momo's internal ERP/HRMS/Employee Management Portal</strong>, supporting 500+ daily active users across HR, payroll, and operations modules</li>
              <li>Participated in daily <strong>Scrum stand-ups and sprint planning</strong> sessions, consistently delivering assigned stories on time across 10+ sprints</li>
              <li>Integrated <strong>new React.js UI components</strong> across 6+ application modules, reducing manual data-entry workflows by an estimated 30%</li>
              <li>Managed and optimized <strong>.NET-based APIs</strong> for seamless frontend-to-backend communication, cutting average API response time by improving query structure</li>
              <li>Authored <strong>20+ SQL scripts and stored procedures</strong> in SQL Server Management Studio (SSMS) for database operations, reporting, and optimization</li>
              <li>Designed and deployed an <strong>automated batch-file CI/CD pipeline</strong> triggered on latest Git commits, reducing manual deployment effort by 60% and eliminating missed-step errors</li>
              <li>Managed <strong>UAT and PROD environment deployments</strong> via Remote Desktop Connection, maintaining zero production rollback incidents over 6 months</li>
              <li>Created and executed <strong>comprehensive test cases</strong> for all new features; resolved 40+ bugs identified during QA cycles, improving release quality</li>
            </ul>
          </div>
          ...
          <div className="ats-exp">
            <div className="ats-exp-header">
              <div className="ats-exp-left">
                <div className="ats-exp-co">Digital Rhombus — Mumbai, India</div>
                <div className="ats-exp-role">MERN Stack Developer Intern</div>
              </div>
            ...
            <ul className="ats-ul">
              ...
              <li>Developed <strong>Your Handyman</strong> — a full-stack Urban Clap clone for home service booking, featuring <strong>Google OAuth authentication</strong> and <strong>Firebase OTP verification</strong></li>
              ...
              <li>Delivered responsive, mobile-first UI designs using React.js and CSS3, achieving consistent layout across Chrome, Firefox, and Safari</li>
            </ul>
          </div>
          ...
          <div className="ats-exp">
            <div className="ats-exp-header">
              <div className="ats-exp-left">
                <div className="ats-exp-co">Tescom — Mumbai, India</div>
                <div className="ats-exp-role">Full Stack MERN Developer Intern</div>
              </div>
              <div className="ats-exp-date">Jul 2023 – Sep 2023</div>
            </div>
            <ul className="ats-ul">
              <li>Developed and deployed <strong>Bharat CXO</strong> and the <strong>TESCOM company website</strong> on Ubuntu Server, serving live production traffic</li>
              <li>Implemented <strong>automated certificate generation, WhatsApp messaging, and bulk email automation</strong> using Pabbly Connect, eliminating 100% of manual certificate workflows</li>
              <li>Managed all business email operations through <strong>Zoho Mail API</strong>, configuring 10+ email accounts and automated transactional workflows</li>
            </ul>
          </div>
          ...
          <div className="ats-exp">
            <div className="ats-exp-header">
              <div className="ats-exp-left">
                <div className="ats-exp-co">DevTown — Remote</div>
                <div className="ats-exp-role">MERN Stack Training Program &amp; Internship</div>
              </div>
      ...
      <div className="ats-page" ref={page2Ref}>
        ...
        {/* PAGE 2 HEADER */}
        <div className="ats-name" style={{fontSize:'16pt', marginBottom:'2px'}}>Gopal Gupta</div>
        <div className="ats-title-line" style={{marginBottom:'10px'}}>MERN Stack Developer | Full Stack Software Developer — Page 2 of 2</div>
        <hr className="ats-divider" />
        ...
        <div className="ats-sec">
          ...
          <div className="ats-edu-row">
            <div className="ats-edu-left">
              <div className="ats-edu-deg">Master of Science (M.Sc.) — Information Technology</div>
              <div className="ats-edu-inst">Mumbai University &nbsp;|&nbsp; CGPA: 9.0 / 10.0</div>
            </div>
          ...
          <div className="ats-edu-row">
            <div className="ats-edu-left">
              <div className="ats-edu-deg">Bachelor of Science (B.Sc.) — Information Technology</div>
              <div className="ats-edu-inst">Mumbai University &nbsp;|&nbsp; CGPA: 9.0 / 10.0</div>
            </div>
          ...
          <div className="ats-edu-row">
            <div className="ats-edu-left">
              <div className="ats-edu-deg">Higher Secondary Certificate (HSC) — Science</div>
              <div className="ats-edu-inst">Maharashtra State Board</div>
            </div>
            <div className="ats-edu-right">Mar 2021<br/>74%</div>
          </div>

          <div className="ats-edu-row">
            <div className="ats-edu-left">
              <div className="ats-edu-deg">Secondary School Certificate (SSC)</div>
              <div className="ats-edu-inst">Maharashtra State Board</div>
            </div>
            <div className="ats-edu-right">Mar 2019<br/>60%</div>
          </div>
        </div>
        ...
        {/* PROJECTS */}
        <div className="ats-sec">
          <div className="ats-sec-title">Projects</div>

          <div className="ats-proj">
            <div className="ats-proj-title">Smart BI Assistant — Agentic AI + SQL Server (Flagship Project)</div>
            <div className="ats-proj-stack">Tech: React.js, Node.js, Express.js, Agentic AI, SQL Server (SSMS), NLP, Natural Language to SQL</div>
            <ul className="ats-ul">
              <li>Built an <strong>Agentic AI-powered Business Intelligence system</strong> that accepts natural-language queries (e.g. "What were today's sales?"), auto-generates SQL, executes against SSMS, and returns human-readable insights</li>
              <li>Eliminated manual SQL query writing for business users; reduced report generation time from hours to seconds</li>
              <li>Designed modular query pipeline with structured output formatting for scalable enterprise deployment</li>
            </ul>
          </div>

          <div className="ats-proj">
            <div className="ats-proj-title">
              RandomType — Typing Speed Test Application
              <a href="https://randomtypee.netlify.app/" target="_blank" rel="noreferrer">randomtypee.netlify.app ↗</a>
            </div>
            <div className="ats-proj-stack">Tech: MongoDB, Express.js, React.js, Node.js (MERN Stack)</div>
            <ul className="ats-ul">
              <li>MERN-stack typing speed test app with real-time WPM and accuracy metrics, deployed on Netlify</li>
              <li>Integrated leaderboard with user authentication and progress persistence via MongoDB</li>
            </ul>
          </div>
          ...
          <div className="ats-proj">
            ...
            <div className="ats-proj-stack">Tech: MERN Stack, Firebase Authentication, Firebase OTP, Google OAuth, GCP</div>
            <ul className="ats-ul">
              <li>Urban Clap clone for booking home services with Google OAuth, Firebase phone OTP, and role-based access control (customer, provider, admin)</li>
            </ul>
          </div>

          <div className="ats-proj">
            <div className="ats-proj-title">Financial Reporting Website</div>
            <div className="ats-proj-stack">Tech: MERN Stack, Chart.js, D3.js, PDF generation</div>
            <ul className="ats-ul">
              <li>Interactive financial statement analysis platform with customizable PDF report generation using Chart.js and D3.js data visualizations</li>
            </ul>
          </div>
          ...
          <div className="ats-proj">
            ...
            <div className="ats-proj-stack">Tech: MERN Stack, Zoho Mail API</div>
            <ul className="ats-ul">
              <li>Platform connecting C-suite executives with membership-based access, event management, and automated transactional email via Zoho Mail API</li>
            </ul>
          </div>

          <div className="ats-proj">
            <div className="ats-proj-title">
              Tescom Business Solution — Corporate Website
              <a href="https://tescom.vercel.app/" target="_blank" rel="noreferrer">tescom.vercel.app ↗</a>
            </div>
            <div className="ats-proj-stack">Tech: MERN Stack, Pabbly Connect, Zoho Mail, WhatsApp API</div>
            <ul className="ats-ul">
        ...
        {/* CERTIFICATIONS & ADDITIONAL SKILLS */}
        <div className="ats-sec">
          <div className="ats-sec-title">Certifications &amp; Additional Skills</div>
          <ul className="ats-cert-list">
            <li><strong>MERN Stack Certification</strong> — DevTown (2022)</li>
            <li>CI/CD Deployment Automation — Batch File &amp; GitHub Actions-based pipelines</li>
            <li>Agile / Scrum Methodology — Sprint planning, daily stand-ups, retrospectives</li>
            <li>RESTful API Design — API creation, testing (Postman), and integration</li>
            <li>Responsive Web Design — Mobile-first, cross-browser compatible UI development</li>
            <li>Third-party API Integration — Firebase, Zoho Mail, Pabbly Connect, WhatsApp API</li>
            <li>Quality Assurance &amp; Testing — Test case creation, execution, and bug resolution</li>
            <li>Version Control — Git branching strategies, GitHub pull requests, code reviews</li>
            <li>Agentic AI Development — NLP, natural-language to SQL pipeline design</li>
            <li>SQL Optimization — Query tuning, indexing, stored procedures, SSMS profiling</li>
            <li>UAT &amp; PROD Environment Management — RDP-based deployment, rollback strategies</li>
          </ul>
        </div>
